...
## Terrastories: Mapping Indigenous place-based stories
...
For #2020IMW we prepared a special build of Terrastories with Indigenous Mapping Workshop data, a video walkthrough of Terrastories, and self-guided tutorials for our session (plus accompanying videos). Check these out below:

**TUTORIALS:**<https://terrastories.app/tutorials/>

**LIVE APP DEMO:** Check out the online app demo build of Terrastories for 2020 indigenous mapping workshop [**here**](<https://terrastories-2020imw.herokuapp.com/cr>).

![](/media/images/IMW2020-Terrastories-Map-1024x576.png)
